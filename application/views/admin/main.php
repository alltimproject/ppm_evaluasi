...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
            ...
            <ul class="nav navbar-nav float-xs-right">
              <li class="dropdown dropdown-user nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  <a class="dropdown-item" data-toggle="modal" data-target="#ganti-password"><i class="icon-lock"></i> Ganti Password</a>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li>
            <a href="#/pelatihan"><i class="icon-table2"></i><span data-i18n="nav.changelog.main" class="menu-title">Pelatihan</span></a>
          </li>
          <li>
            <a href="#/evaluasi"><i class="icon-stats-dots"></i><span data-i18n="nav.changelog.main" class="menu-title">Evaluasi</span></a>
          </li>
          <li>
            <a href="#/user"><i class="icon-head"></i><span data-i18n="nav.changelog.main" class="menu-title">User</span></a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <!-- ////////////////////////////////////////////////////////////////////////////-->
<!-- Modal -->
<div class="modal fade text-xs-left" id="ganti-password" tabindex="-1" role="dialog" aria-labelledby="myModalLabel19" aria-hidden="true">
